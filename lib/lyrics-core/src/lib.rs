...
//! binaries and the subtitle generation library build upon: the
//! collections, video, credits, and line-marker descriptors, the
//! timestamp primitives, and the file snapshot helper.

pub mod collections_descriptor;
